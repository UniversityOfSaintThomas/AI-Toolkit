...
*   Set the `resourceUrl` field to the path: `/public/resources/YOUR-FILE-NAME.EXTENSION`.
    *   For example, if your file is `my-resource.pdf`, the `resourceUrl` would be `/public/resources/my-resource.pdf`.
